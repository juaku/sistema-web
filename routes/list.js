                          ...
                          nested: {
                            ...
                            query: {
                              bool: {
                                must: {
                                  term: {
                                    "reportedBy._id": req.session.idMongoDb,
                                  },
                                },
                              },
                            },
          ...
          functions: [
            {
              gauss: {
                geo: {
                  origin:
                    req.session.coords.longitude +
                    "," +
                    req.session.coords.latitude, // "-71.536742,-16.398735",
                  offset: "1km",
                  scale: "2km",
                },
              },
